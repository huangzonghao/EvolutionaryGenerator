// Adapted from ChIrrCamera.h of Project Chrono 6.0.0
//
// =============================================================================
...
#ifndef EVOGEN_SIMULATOR_INCLUDE_CHIRREVOGENCAMERA_H_
#define EVOGEN_SIMULATOR_INCLUDE_CHIRREVOGENCAMERA_H_
...
class EvoGenCamera : public irr::scene::ICameraSceneNode {
  public:
    EvoGenCamera(irr::IrrlichtDevice* devicepointer,
...
#endif /* end of include guard: EVOGEN_SIMULATOR_INCLUDE_CHIRREVOGENCAMERA_H_ */
