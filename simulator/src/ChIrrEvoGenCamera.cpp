// Adapted from ChIrrCamera.cpp of Project Chrono 6.0.0
//
// =============================================================================
...
EvoGenCamera::EvoGenCamera(IrrlichtDevice* devicepointer,
                           ISceneNode* parent,
                           ISceneManager* smgr,
                           s32 id,
                           f32 rs,
...
bool EvoGenCamera::OnEvent(const SEvent& event) {
...
void EvoGenCamera::OnRegisterSceneNode() {
...
void EvoGenCamera::OnAnimate(u32 timeMs) {
    animate();
...
bool EvoGenCamera::isInputReceiverEnabled() const {
    _IRR_IMPLEMENT_MANAGED_MARSHALLING_BUGFIX;
    return InputReceiverEnabled;
}

void EvoGenCamera::setNearValue(f32 f) {
    ZNear = f;
    recalculateProjectionMatrix();
}

void EvoGenCamera::setFarValue(f32 f) {
    ZFar = f;
    recalculateProjectionMatrix();
}

void EvoGenCamera::setAspectRatio(f32 f) {
    Aspect = f;
    recalculateProjectionMatrix();
}

void EvoGenCamera::setFOV(f32 f) {
    Fovy = f;
    recalculateProjectionMatrix();
}

void EvoGenCamera::setViewMatrixAffector(const core::matrix4& affector) {
    Affector = affector;
}

void EvoGenCamera::setUpVector(const core::vector3df& pos) {
    UpVector = pos;
}

void EvoGenCamera::setProjectionMatrix(const core::matrix4& projection, bool isOrthogonal) {
    Projection = projection;
}

void EvoGenCamera::setPosition(const core::vector3df& pos) {
    Pos = pos;
...
void EvoGenCamera::setTarget(const core::vector3df& pos) {
    Target = oldTarget = pos;
    updateAnimationState();
}

void EvoGenCamera::setZoomSpeed(f32 value) {
    zoomSpeed = value;
}

void EvoGenCamera::setTranslateSpeed(f32 value) {
    translateSpeed = value;
}

void EvoGenCamera::setRotationSpeed(f32 value) {
    rotateSpeed = value;
}

void EvoGenCamera::pointCameraAtNode(ISceneNode* selectednode) {
...
void EvoGenCamera::setMinZoom(f32 amount) {
    targetMinDistance = amount;
}

void EvoGenCamera::setMaxZoom(f32 amount) {
    targetMaxDistance = amount;
}

void EvoGenCamera::recalculateProjectionMatrix() {
...
void EvoGenCamera::recalculateViewArea() {
...
void EvoGenCamera::allKeysUp() {
    for (int i = 0; i < KEY_KEY_CODES_COUNT; i++)
        Keys[i] = false;
}

void EvoGenCamera::allMouseKeysUp() {
    for (s32 i = 0; i < 3; ++i)
        MouseKeys[i] = false;
}

bool EvoGenCamera::isKeyDown(s32 key) {
    return Keys[key];
}

bool EvoGenCamera::isMouseKeyDown(s32 key) {
    return MouseKeys[key];
}

void EvoGenCamera::animate() {
    // Rotation Vals
    f32 nRotX = rotX;
    f32 nRotY = rotY;
...
void EvoGenCamera::updateMatrices() {}
