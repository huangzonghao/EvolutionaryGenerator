    ...
    for i = 1 : size(test_plan, 2) - 1
        ...
        for j = i + 1 : size(test_plan, 2)
            ...
            fprintf(fid, ['===============================================================\n', ...
                          ...
                          'Avg Best Fits of Map: H %d, P %d\n', ...
                          '%s:\n', ...
                          '    Avg of Avg Fits of Map: %.4f, Avg of Best Fits of Map: %.4f\n', ...
                          '    Avg Fits Raw: %s\n', ...
                          '    Best Fits Raw: %s\n', ...
                          '%s:\n', ...
                          '    Avg of Avg Fits of Map: %.4f, Avg of Best Fits of Map: %.4f\n', ...
                    ...
                    result_i.name, ...
                    raw{1}.fits_mean, raw{1}.best_fits_mean, ...
                    format_array(raw{1}.fits), format_array(raw{1}.best_fits), ...
                    result_j.name, ...
                    raw{2}.fits_mean, raw{2}.best_fits_mean, ...
                    format_array(raw{2}.fits), format_array(raw{2}.best_fits));

            fprintf(sumfile_id, 'H: %d, P: %d, L: %.2f, R: %.2f\t', report.H1, report.P1, raw{1}.fits_mean, raw{2}.fits_mean);
            fprintf(best_sumfile_id, 'H: %d, P: %d, L: %.2f, R: %.2f\t', report.H2, report.P2, raw{1}.best_fits_mean, raw{2}.best_fits_mean);
        end
        fprintf(sumfile_id, '\n');
        fprintf(best_sumfile_id, '\n');
    end
