    ...
    for i = 1 : size(test_plan, 2) - 1
        ...
        for j = i + 1 : size(test_plan, 2)
            ...
            fprintf(fid, ['=================================================\n', ...
                          ...
                          '%s:\n', ...
                          '    avg final all fits: %.2f, avg final elite fits: %.2f\n', ...
                          '    avg gen for all fits: %.2f, avg gen for elite fits: %.2f\n', ...
                          '    all fits gen raw: %s\n', ...
                          '    elite fits gen raw: %s\n', ...
                          '%s:\n', ...
                          '    avg final all fits: %.2f, avg final elite fits: %.2f\n', ...
                          '    avg gen for all fits: %.2f, avg gen for elite fits: %.2f\n', ...
                          '    all fits gen raw: %s\n', ...
            ...
            fprintf(elite_sumfile_id, 'H: %d, P: %d, L: %.2f, R: %.2f\t', report.H2, report.P2, mean(raw{1}.elite_fit_gen), mean(raw{2}.elite_fit_gen));
        end
        fprintf(sumfile_id, '\n');
        fprintf(elite_sumfile_id, '\n');
    end
